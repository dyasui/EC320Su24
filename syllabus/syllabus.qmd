...
|                 | **Lecture**                                             | **Lab**            |
|-----------------|---------------------------------------------------------|--------------------|
| **when**        | T & Th 12:00p--1:20p                                    | 4:00-4:50p W       |
| **where**       | [Tykeson Hall 140](https://map.uoregon.edu/8f5f1a72c)   | [Zoom](https://canvas.uoregon.edu/)         | <!-- TODO: Add Canvas link--> 
| **who**         | **Andrew Dickinson**                                    | **Dante Yasui**    |
|  \hfill {{< fa paper-plane >}} | [adickin3@uoregon.edu](mailto:adickin3@uoregon.edu)     | [dyasui@uoregon.edu](mailto:dyasui@uoregon.edu) | (Use "EC320:" in email subject.) |
|  \hfill {{< fa cloud >}}               | [ajdickinson.github.io](https://ajdickinson.github.io)  | [cas.uoregon.edu](https://cas.uoregon.edu/directory/economics/all/dyasui) |
| **office hours**| TBA                                                     | TBA                | (Or by appointment) |
| **materials**   | [1. Introduction to Econometrics](http://smile.amazon.com/Introduction-Econometrics-Christopher-Dougherty/dp/0199676828/) | |
|                 | [2. Mastering 'Metrics](https://www.amazon.com/Mastering-Metrics-Path-Cause-Effect/dp/0691152845/) | |
| **repository**  | [github.com/ajdickinson/EC320S24](https://github.com/ajdickinson/EC320S24) | |
