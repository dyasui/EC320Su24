...
The [OLS estimator]{.note} chooses the parameters $\hat{\beta_0}$ and $\hat{\beta_1}$ that minimize the [residual sum of squares (RSS):]{.hii}

$$
\min_{\hat{\beta}_0,\, \hat{\beta}_1} \quad \color{#BF616A}{\sum_{i=1}^n \hat{u}_i^2}
$$
