...
format: 
  revealjs:
    ...
    slide-number: true
    footer: "EC320, Set 03 | Lecture 5: Properties of OLS"
    preview-links: auto
    code-fold: FALSE
    # code-copy: TRUE
...
3. [Goodness of Fit](@sec-rsquared)
4. [Returns to Schooling example](@sec-example)
5. [Assumptions](@sec-assumptions)
6. [Gauss-Markov](@sec-gaussmarkov)
7. [Simulations](@sec-simulation)
:::
