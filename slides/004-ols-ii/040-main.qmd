...
format: 
  revealjs:
    ...
    slide-number: true
    footer: "EC320, Set 03 | Simple linear regression (again)"
    preview-links: auto
    code-fold: FALSE
    # code-copy: TRUE
...
- Due tonight at 11:59p
- [PS03]{.hi} will post today
:::
...
- Due Friday at 5:00p
- K06: Final `dplyr` lesson
- K06b: linear models (`lm`) lesson
  - Issue with testing file
  - To fix, redownload: "tests/testhat/test-K06b_lm.R"
