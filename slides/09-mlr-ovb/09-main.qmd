---
title: "Multiple Linear Regression and Omitted Variable Bias"
...
format: 
  revealjs:
    ...
    slide-number: true
    footer: "EC320, Set 09 | Omitted Variable Bias"
    preview-links: auto
    code-fold: FALSE
    code-copy: TRUE
...
{{< include 09-2-ovb.qmd >}}

# _Multiple linear regression_ {.inverse .note}

{{< include 09-3-multi.qmd >}}

# _Adjusted R-squared_ {.inverse .note}

{{< include 09-4-adjRsquared.qmd >}}
...
renderthis::to_pdf(
  from = "./slides/09-mlr-ovb/09-mlr-ovb.html",
  to = "./slides/09-multiple/09-main.pdf",
  complex_slides = TRUE
)
```