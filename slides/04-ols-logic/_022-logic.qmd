...
Regression models forces us to be explicit about the potential sources of bias
...
[Ex.]{.ex} Not controlling for confounding variables, leads to [omitted-variable bias]{.note}, a close cousin of bias
