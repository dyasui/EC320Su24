...
> Gaining confidence in our understanding of the world.
...
- [How responsive are polluters to a carbon tax?]{.tiny}
:::
...
> 
> Gain confidence in statistical evidence-backed arguments
...
- Data is the new oil
- Extracting meaningful analysis from _big data_ is a sought after skill in the job market of 2024
...
Econometrics is built on crucial [fundamentals]{.note}. 
These [fundamentals]{.note} is the focus of this class.
...
1. [Prediction:]{.hp} 
Accurately [predict]{.purple} or [forecast]{.purple} an outcome given a set of predictors.
[Given what we know about]{.purple} $x$, [what values do we expect]{.purple} $y$ [to take?]{.purple}

. . .

2. [Causal identification:]{.hii} 
[Estimate]{.blue} the effect of an intervention on an outcome. 
[How does]{.blue} $y$ [change when we change]{.blue} $x$[?]{.blue}

. . .

In this class, and in [EC 421]{.hii}, we will focus on the [later]{.hii}. 
The [former]{.hp} is the focus of [EC 422]{.hp} and [EC 524]{.hp}
