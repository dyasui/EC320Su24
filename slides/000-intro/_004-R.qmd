...
- {{< fa brands r-project >}} was created for the statistical and graphical work required by econometrics
--written by statistical programmers

- {{< fa brands r-project >}} has a vibrant, thriving online community. 
...
1\. {{< fa brands r-project >}} is [free]{.hi} and [open source]{.hi}
—saving both you and the university money.

<br>

2\. _Related:_ Outside of a small group of economists, private- and public-sector 
[employers favor {{< fa brands r-project >}}]{.blue} over [Stata]{.hi} and most competing softwares.

<br>

3\. {{< fa brands r-project >}} is very [flexible and powerful]{.hi}
...
4\. _Related:_ {{< fa brands r-project >}} imposes [no artificial restrictions]{.hi} 
on your amount of observations, variables, memory, or processing power.

<br>

5\. If you put in the work,
^[Learning {{< fa brands r-project >}} definitely requires time and effort.] 
