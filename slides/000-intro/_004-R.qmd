...
- [ ]{.nf} was created for the statistical and graphical work required by econometrics--written by statistical programmers

- [ ]{.nf} has a vibrant, thriving online community. ([stack overflow](https://stackoverflow.com/questions/tagged/r))
...
1\. [ ]{.nf} is [free]{.hi} and [open source]{.hi}—saving both you and the university money.

<br>

2\. _Related:_ Outside of a small group of economists, private- and public-sector [employers favor [ ]{.nf}]{.blue} over [Stata]{.hi} and most competing softwares.

<br>

3\. [ ]{.nf} is very [flexible and powerful]{.hi}—adaptable to nearly any task, _e.g._, 'metrics, spatial data analysis, machine learning, web scraping, data cleaning, website building, teaching. I write all my slides, problem sets, and exams in [R]{.mono}.

---

## Why are we using [ ]{.nf}?

4\. _Related:_ [ ]{.nf} imposes [no artificial restrictions]{.hi} on your amount of observations, variables, memory, or processing power.

<br>

5\. If you put in the work,^[Learning [ ]{.nf} definitely requires time and effort.] you will come away with a [valuable and marketable]{.hi} tool.
...
[ ]{.nf} works without [RStudio]{.hi}, but [RStudio]{.hi} doesn't work without [ ]{.nf}
