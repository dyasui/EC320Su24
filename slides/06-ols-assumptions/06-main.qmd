...
format: 
  revealjs:
    ...
    slide-number: true
    footer: "EC320, Lecture 6 | OLS Assumptions"
    preview-links: auto
    code-fold: FALSE
    # code-copy: TRUE
...
::: {.column width="50%"}
<!-- 1. [Review](@sec-prologue) -->
<!-- 1. [Properties](@sec-properties) -->
<!-- 1. [Goodness of Fit](@sec-rsquared) -->
<!-- 1. [Returns to Schooling example](@sec-example) -->
1. [Assumptions](@sec-assumptions)
  - Assumptions A1-A3 -> unbiasedness
  - Assumptions A4-A6: distribution of the errors
1. [Gauss-Markov](@sec-gaussmarkov)
1. [Simulations](@sec-simulation)
:::
...
{{< include 06-1-assumptionsA1-A3.qmd >}}

{{< include 06-2-assumptionsA4-A6.qmd >}}

# _Gauss Markov_ {.inverse .note} 

{{< include 06-3-gaussmarkov.qmd >}}

# _Population vs. sample, revisited_ {.inverse .note} 

{{< include 06-4-sims.qmd >}}
...
renderthis::to_pdf(from = "./slides/006-ols-assumptions/060-main.html", to = "./slides/006-ols-assumptions/060-main.pdf")
```
